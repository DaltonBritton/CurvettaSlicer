...
public:
    ...
    void Decorate(wxBitmap& bmp)
    {
        ...
        auto bs_version = wxString::Format(_L("Based on PrusaSlicer, BambuStudio, and OrcaSlicer")).ToStdString();
...
/*#ifdef WIN32
    ...
    try {
        ...
        flush_logs();
        wxString errmsg = wxString::Format(_L("CurvettaSlicer will terminate because of running out of memory. "
