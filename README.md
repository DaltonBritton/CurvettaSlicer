...
<picture>
  <img alt="CurvettaSlicer logo" src="resources/images/OrcaSlicer.png" width="15%" height="15%">
</picture>
...
CurvettaSlicer: an open source Next-Gen Slicing Software for Precision 3D Prints.  
...
There are several clickbait and malicious websites pretending to be Official CurvettaSlicer. These sites may redirect you to dangerous downloads or contain misleading information.
<br><br>
...
Visit our GitHub Releases page for the latest stable version of Curvetta Slicer, recommended for most users.

## Nightly Builds
🌙 **[Download the Latest Nightly Build](https://github.com/SoftFever/OrcaSlicer/releases/tag/nightly-builds)**  
Explore the latest developments in Curvetta Slicer with our nightly builds. Feedback on these versions is highly appreciated.
...
2. Drag CurvettaSlicer.app to Application folder.
...
## Linux (Ubuntu):
 1. If you run into trouble executing it, try this command in the terminal:
    `chmod +x /path_to_appimage/CurvettaSlicer_Linux.AppImage`

# How to Compile
All updated build instructions for Windows, macOS, and Linux are now available on the official [CurvettaSlicer Wiki - How to build](https://github.com/SoftFever/CurvettaSlicer/wiki/How-to-build) page.
...
# Supports
**Curvetta Slicer** is an open-source project and I'm deeply grateful to all my sponsors and backers.  
...
# License
**Curvetta Slicer** is licensed under the GNU Affero General Public License, version 3. Curvetta Slicer is based on Bambu Studio by BambuLab.
...
Curvetta Slicer includes a pressure advance calibration pattern test adapted from Andrew Ellis' generator, which is licensed under GNU General Public License, version 3. Ellis' generator is itself adapted from a generator developed by Sineos for Marlin, which is licensed under GNU General Public License, version 3.

The bambu networking plugin is based on non-free libraries from Bambulab. It is optional to the Curvetta Slicer and provides extended functionalities for Bambulab printer users.
