...
Visit our GitHub Releases page for the latest stable version of CurvettaSlicer, recommended for most users.

## Nightly Builds

🌙 **[Download the Latest Nightly Build](https://github.com/SoftFever/OrcaSlicer/releases/tag/nightly-builds)**  
Explore the latest developments in CurvettaSlicer with our nightly builds. Feedback on these versions is highly appreciated.
...
3. *If you want to run a build from a PR, you also need to follow the instructions below:*
    ...
    - Option 2:
      ...
      ```shell
      xattr -dr com.apple.quarantine /Applications/CurvettaSlicer.app
      ```
...
All updated build instructions for Windows, macOS, and Linux are now available on the official [CurvettaSlicer Wiki - How to build](https://github.com/SoftFever/OrcaSlicer/wiki/How-to-build) page.
...
**CurvettaSlicer** is an open-source project and I'm deeply grateful to all my sponsors and backers.  
